                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr data-rowid="{{ $cart->rowId }}">
                                ...
                                <td class="p-price first-row">{{ number_format($cart->price, 3)}}vnd</td>
                                ...
                                <td class="toltal-price first-row">{{ number_format($cart->price * $cart->qty, 3)}}vnd</td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-lg-4">
                        <div class="proceed-checkout">
                            <ul>
                                <li class="subtotal">Tổng tiền trước thuế <span>{{ $total }}vnd</span></li>
                                <li class="cart-total">Tổng tiền <span>{{ $subtotal }}vnd</span></li>
                            </ul>
