                    ...
                    <input type="hidden" name="product_id" value="{{ $product->id }}">
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input disabled placeholder="Tên" type="text" class="form-control" value="{{ $product->name }}">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="color" id="color" placeholder="Màu" type="text" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="size" id="size" placeholder="Kích cỡ" type="text" class="form-control" value="">
                            </div>
                        </div>
